...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //ldf
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(1, 0,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //rdf
            VertexFormat(glm::vec3(0, 1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //luf
            VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //ruf

            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //ldb
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //rdb
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //lub
            VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //rub
        };
...

    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0.5, 1, 0.5), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
        };
        ...
        meshes["tet"] = new Mesh("generated tetrahedron");
...

    {
        ...
        meshes["pat"] = new Mesh("generated patrat");
        meshes["pat"]->InitFromData(vertices, indices);
    }
}
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-1, 0.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tet"], shaders["VertexColor"], glm::vec3(2, 0, 0), glm::vec3(2.5));

    // TODO(student): Draw the square
    RenderMesh(meshes["pat"], shaders["VertexColor"], glm::vec3(-4, 0, 0), glm::vec3(2));
